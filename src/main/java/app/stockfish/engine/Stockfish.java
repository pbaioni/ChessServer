...
public class Stockfish extends UCIEngine {
	...
	public String getEngineEvaluation(Query query) {
        ...
        for(String line : response) {
        	if(line.startsWith("info depth 25 seldepth")) {
        		evaluation = line.split("score cp")[1].trim().split(" ")[0];
        	}
        	if(line.startsWith("bestmove")) {
        		bestMove = line.substring(9).split("\\s+")[0];
        	}
        }
        ...
        System.out.println("Engine evaluation: " + rval);
        return rval;
	}
